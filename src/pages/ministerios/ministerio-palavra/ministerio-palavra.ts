...
/**
 * Generated class for the MinisterioPalavraPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-ministerio-palavra',
  templateUrl: 'ministerio-palavra.html',
})
export class MinisterioPalavraPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public db: AngularFireDatabase,public modalCtrl: ModalController) {
      this.ministerio = db.object("/ministerios/22");
  ...
  openContato() {
    let modal = this.modalCtrl.create(ContatoModalPage, {ministerio: 22});
    modal.present();
  }
