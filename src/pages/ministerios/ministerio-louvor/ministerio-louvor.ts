...
/**
 * Generated class for the MinisterioLouvorPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-ministerio-louvor',
  templateUrl: 'ministerio-louvor.html',
})
export class MinisterioLouvorPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public db: AngularFireDatabase,public modalCtrl: ModalController) {
      this.ministerio = db.object("/ministerios/11");
  ...
  openContato() {
    let modal = this.modalCtrl.create(ContatoModalPage, {ministerio: 11});
    modal.present();
  }
