...
/**
 * Generated class for the MinisterioAcolhimentoPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-ministerio-acolhimento',
  templateUrl: 'ministerio-acolhimento.html',
})
export class MinisterioAcolhimentoPage {
