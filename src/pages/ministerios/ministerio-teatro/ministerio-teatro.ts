...
/**
 * Generated class for the MinisterioTeatroPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-ministerio-teatro',
  templateUrl: 'ministerio-teatro.html',
})
export class MinisterioTeatroPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public db: AngularFireDatabase,public modalCtrl: ModalController) {
      this.ministerio = db.object("/ministerios/17");
  ...
  openContato() {
    let modal = this.modalCtrl.create(ContatoModalPage, {ministerio: 17});
    modal.present();
  }
