...
/**
 * Generated class for the MinisterioCoralPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-ministerio-coral',
  templateUrl: 'ministerio-coral.html',
})
export class MinisterioCoralPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public db: AngularFireDatabase,public modalCtrl: ModalController) {
      this.ministerio = db.object("/ministerios/2");
  ...
  openContato() {
    let modal = this.modalCtrl.create(ContatoModalPage, {ministerio: 2});
    modal.present();
  }
